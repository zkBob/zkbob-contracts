 ...
 * It is intended to be deployed as an implementation for BOB->USDC.e->USDC Polygon pool.
 */
contract ZkBobPoolUSDCMigrated is ZkBobPool, ZkBobTokenSellerMixin, ZkBobUSDCPermitMixin {
    ...
    function fillMigrationOrder(uint256 _amount) external {
        require(block.timestamp < 1701388800); // 01 Dec 2023 00:00:00
        IERC20(token).safeTransferFrom(msg.sender, address(this), _amount);
        IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174).safeTransfer(msg.sender, _amount);
    }
}
